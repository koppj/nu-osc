...
double n0_cor(double eNu)
{
  ...
  is = U235;
  double v = read("Dat/Patrick-U235-err_cor.dat", eNu) * flux_kaml(eNu);
  is = P239;
  v += read("Dat/Patrick-Pu239-err_cor.dat", eNu) * flux_kaml(eNu);
  is = P241;
  v += read("Dat/Patrick-Pu241-err_cor.dat", eNu) * flux_kaml(eNu);
