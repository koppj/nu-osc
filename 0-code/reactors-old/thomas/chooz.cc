...
double fold_corr(double eNu){
  iso_gl = U235;
  double w = read("Dat/Patrick-U235-err_cor.dat", eNu) * my_flux(eNu);
  iso_gl = P239;
  w += read("Dat/Patrick-Pu239-err_cor.dat", eNu) * my_flux(eNu);
  iso_gl = P241;
  w += read("Dat/Patrick-Pu241-err_cor.dat", eNu) * my_flux(eNu);
