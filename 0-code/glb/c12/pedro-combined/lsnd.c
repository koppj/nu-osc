/**********************         LSND         *********************
 *
 * LSND simulation: Carbon cross section
 *
 * Author: PAN Machado
 * Date:   May-2012
 *
...
double LSchi(int exp, int rule, int n_params, 
...
/* Default density correlation list: Every experiment independent */
  ...
  /* Initialize LSND */
  glbDefineChiFunction(&LSchi,   1,    "LSchi", NULL);
   ...
   * CHI^2 - th13 x chi2
   *************************************************************************/
  FILE* chi2file=fopen("LS-chi.dat","w");
