...
{  
  ...
  // the pulls
  cff[b][PULL_U235_0] = cff[b][NPULLS]*rate_pull_coupl.unc(U235, 0, isofract_PV);
  cff[b][PULL_P239_0] = cff[b][NPULLS]*rate_pull_coupl.unc(P239, 0, isofract_PV); 
  cff[b][PULL_P241_0] = cff[b][NPULLS]*rate_pull_coupl.unc(P241, 0, isofract_PV);
  cff[b][PULL_U238]   = cff[b][NPULLS]*rate_pull_coupl.unc(U238, 0, isofract_PV);
