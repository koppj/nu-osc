...
// this code uses data from 1009.4771 corresponding to 2135 live days (March 9, 2002 to Nov 4, 2009)
// this should approximately correspond to periods 1 and 2 of 1303.4667
// we do not include the "reactor off" period from 1303.466
 ...
 * first col: reactor fraction, second col: distance (km). 
...
void init_kaml(void)  
{
   ...
   for(int i = 0; i < NBIN_KAML; i++){
	...
	error("error in reading Data_KamL/data2010.out");
