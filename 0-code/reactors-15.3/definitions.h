...
// Some experiments are not used because the corresponding codes
// are either not tested or not working for sterile neutrinos
#ifdef USE_ALL
# define USE_SBL
# define USE_KAML
# define USE_RENO
...
#ifdef FLUX_FREE
# define BUG_SPECT_FREE 
#endif

namespace ns_reactor
{

enum EXPERIMENTS {SBL, CHOOZ, PV, KAML, DC, DB, RENO, BUG_SP, DANSS, GAL, DB_FLUX, N_EXP};

enum SBL_Reactors {BUGEY4, ROVNO, BUGEY3_1, BUGEY3_2, BUGEY3_3, 
		   GOSGEN_1, GOSGEN_2, GOSGEN_3, ILL, 
		   KRASN_1, KRASN_2, KRASN_3, KRASN_4, 
                   SRP_1, SRP_2, 
...
#ifdef USE_DC
# define NBIN_DC 56
# define NPULL_DC 3 // E-scale FD-I, NF, system lowE, highE, FD-I, NF
#else
# define NBIN_DC 0
# define NPULL_DC 0
#endif
...
# ifdef BUG_SPECT_FREE   
#  define NPULL_BUG_SP 26
# else 
...
#ifdef USE_DB_FLUX
# define NBIN_DB_FLUX 8
# define NPULL_DB_FLUX 1
#else
# define NBIN_DB_FLUX 0
# define NPULL_DB_FLUX 0
#endif
 
/* total bins in chisq */
#define NBIN_CHISQ (NBIN_SBL + NBIN_CHOOZ + NBIN_PV + NBIN_KAML + NBIN_DC + NBIN_DB + NBIN_RENO + NBIN_BUG_SP + NBIN_DANSS + NBIN_GAL + NBIN_DB_FLUX)
...
#define NPULLS (PULL_GLOBAL + NPULL_SBL + NPULL_CHOOZ + NPULL_PV + NPULL_KAML + NPULL_DC + NPULL_DB + NPULL_RENO + NPULL_BUG_SP + NPULL_DANSS + NPULL_GAL + NPULL_DB_FLUX)
